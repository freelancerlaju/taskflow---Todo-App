  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        foreground: "var(--color-foreground)", /* dark slate */
        ...
        popover: {
          ...
          foreground: "var(--color-popover-foreground)", /* dark slate */
        },
        card: {
          DEFAULT: "var(--color-card)", /* pure white */
          foreground: "var(--color-card-foreground)", /* dark slate */
        },
        success: {
        ...
        'text-primary': "var(--color-text-primary)", /* dark slate */
